...
export function MobileNav() {
  ...
  return (
    ...
    >
      <ul className="flex items-center gap-1 rounded-badge border border-border bg-surface/85 px-2 py-2 shadow-[0_0_30px_rgba(139,92,246,0.15)] backdrop-blur-md">
            ...
            <li key={link.id}>
              <a
                ...
                className={`flex h-11 w-11 items-center justify-center rounded-full transition-all duration-300 ${
                  isActive
                    ? "bg-accent-violet/20 text-text-primary shadow-[0_0_16px_rgba(139,92,246,0.5)]"
