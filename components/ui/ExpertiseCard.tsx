...
export function ExpertiseCard({ number, title, description, chips }: ExpertiseCardProps) {
  return (
    <div className="group rounded-card border border-border bg-surface/60 p-6 transition-all duration-300 hover:-translate-y-1 hover:border-accent-violet/30 hover:shadow-[0_0_30px_rgba(169,143,210,0.18)] sm:p-7">
